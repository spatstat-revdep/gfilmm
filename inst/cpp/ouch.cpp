...
/*** R
xx <- gfilmm::gfilmm(~ cbind(y, y+1), ~ 1, NULL, data.frame(y = c(1,2,3)), N = 1000)
gf <- gfilmm_double(L = c(1, 2, 3), U = c(2, 3, 4), FE = cbind(c(1,1,1)), RE = xx$RE, RE2 = xx$RE2, E = xx$E, N = 1000L, thresh = 500, seed = 666L, nthreads = 2L)
*/