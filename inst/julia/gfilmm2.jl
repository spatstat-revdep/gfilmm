...
#srand(421)
gfilmm2 = function (data::Array{R,2}, FE::Array{R,2}, RE::Array{Int64,2}, N::Int64, thresh::R) where {R<:Real}
...
(VERTEX, WEIGHT) = gfilmm2(data, FE, RE, 5000, 2500.0)
